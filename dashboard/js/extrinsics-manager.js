...
class ExtrinsicsManager {
    ...
    getPalletRegistry() {
        return [
            ...
            {
                name: 'TransparenceOracle', index: 34, category: 'Transparence Integration',
            ...
            {
                name: 'TransparenceTwoManRule', index: 35, category: 'Transparence Integration',
            ...
            {
                name: 'TransparenceDeliverables', index: 36, category: 'Transparence Integration',
            ...
            // --- Identity ---
            {
                name: 'IdentityRegistry', index: 37, category: 'Identity',
