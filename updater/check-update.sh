...
HEALTH_URL="${HEALTH_URL:-http://localhost:9944/health}"
NODE_CONTAINER="${NODE_CONTAINER:-quantumharmony-node}"
COMPOSE_FILE="${COMPOSE_FILE:-/compose/docker-compose.operator.yml}"
COMPOSE_PROJECT="${COMPOSE_PROJECT:-quantum-harmony-node}"
